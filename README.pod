...
=for HTML <a href="https://travis-ci.org/briandfoy/wordpress-grep"><img src="https://travis-ci.org/briandfoy/wordpress-grep.svg?branch=master"></a>
...
=for HTML <a href="http://www.metacpan.org/module/WordPress::Grep"><img src="https://img.shields.io/cpan/v/WordPress-Grep.svg" /></A>

=head1 The WordPress::Grep module

This is the I<README> for the L<WordPress::Grep> Perl module. You're probably 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/WordPress-Grep> or 
L<MetaCPAN|http://www.metacpan.org/module/WordPress::Grep>:

=over 4

=item *	L<http://search.cpan.org/dist/WordPress-Grep>

=item *	L<http://www.metacpan.org/module/WordPress::Grep>
