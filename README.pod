...
the source repository: L<https://github.com/briandfoy/Wordpress-Grep>
...
=item * L<https://bitbucket.com/briandfoy/Wordpress-Grep>

=item * L<https://codeberg.org/briandfoy/Wordpress-Grep>

=item * L<https://gitlab.com/briandfoy/Wordpress-Grep>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify WordPress-Grep-1.23.tar.gz --owner briandfoy
